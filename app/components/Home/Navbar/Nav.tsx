...
const Nav = ({ openNav }: Props) => {
  ...
  return (
    <div
      className={`${navBg ? "bg-green-900 shadow-md" : ""} 
  transition-all duration-200 h-[8vh] sm:h-[10vh] md:h-[12vh] z-1000 fixed w-full`}
    >
      <div className="flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-4">
          <button
            className="md:px-12 md:my-2.5 px-8 py-2  text-black text-base bg-white
